...
alias jettyup="sudo service jetty start"
...
function emberdeploy {
	cd ~/hackwest3/frontend
	ember build --environment=production
	cp dist/* ~/hackwest3/backend/static
	cp ~/hackwest3/backend/static/index.html ~/hackwest3/backend/templates/
}
